            ...
            <Container className={classes.Container}>
                ...
                <div>
                    <Card className={classes.Card}>
                        <CustomCardTitle headerIcon="1" headerTitle="Lock Or Manage Tokens" />
                        <div className={classes.content}>
                            ...
                            >
                                <Tab label="LOCK TOKENS" />
                                <Tab label="MANAGE LOCKED TOKENS" />
                            </Tabs>
                            <div className={classes.tabContent}>
                                <CustomTabPanel value={value} index={0} dir={theme.direction}>
                                    <p>Use the DxLock Token Locker to lock your tokens and earn greater trust within your community!</p>
                                    <br />
                                    ...
                                    <Grid container>
                                        ...
                                        <Grid item xs={6}>
                                            <Card className={classes.formCard}>
                                                <p className={'mg0'}>DxLock Token Locker</p>
                                                <CustomInput label="Enter Token Address" placeholder="Ex. 0xF063fE1aB7a291c5d06a86e14730b00BF24cB589" />
                                            </Card>
                                        </Grid>
                                        <Grid item xs={3}></Grid>
                                    </Grid>
