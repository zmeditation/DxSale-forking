...
import { Card, Container, Tabs, Tab, Fab, Grid, Paper, Divider, Button } from '@material-ui/core';
                        ...
                        <div className={classes.tabContent}>
                            <CustomTabPanel value={value} index={0} dir={theme.direction}>
                                <Grid container>
                                    ...
                                    <Grid item xs={3}>
                                        <div>
                                            <Button href="/app/pages/dxlockv1?chain=ETH" target="_blank" size="large" className={classes.linkbtn}><span className={'fs8 fw6 textBlue'}>V1 CONTRACTS</span></Button>
                                        </div>
                                    </Grid>
                                </Grid>
                                <Grid container>
                                    <Grid item xs={4}>
                                        <CustomLockPan id="0" add="0x154922E74D108B1f92d702529b31027de54A1933" type="lplock" chain="ETH" route="/app/pages/dxlockview">
                                            <div>
                                                <p className={'fwbold fs125em'}>HERO/WETH</p>
                                                <div className={'pl3'}>
                                                    <p className={'fs115em '}>
                                                        <CalendarTodayIcon className={classes.icon} />
                                                        <span>1 Jan 2100 at 07:35</span>
                                                    </p>
                                                </div>
                                                <br />
                            ...
                            <CustomTabPanel value={value} index={1} dir={theme.direction}>
                                <Grid container>
                                    <Grid item xs={3}>
                                        <Fab variant="extended" href="/app/pages/dxlocktokencreate" color="primary" size="medium" className={classes.Fab}>
                                ...
                                <Grid container>
                                    <Grid item xs={4}>
                                        <CustomLockPan id="0" add="0x154922E74D108B1f92d702529b31027de54A1933" type="tokenlock" chain="ETH" route="/app/pages/dxlockview">
                                            <div>
