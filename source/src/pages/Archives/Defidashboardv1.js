                ...
                <div>
                    <Card className={classes.Card}>
                        ...
                        <div>
                            <CustomSearch>
                                <div>
                                    <Tooltip title="Switch to V2 contracts" placement="bottom">
                                        <Button href="/app/defi-dashboard?chain=ETH" target="_blank" size="large" className={classes.linkbtn}><span className={'fs8 fw6 textBlue'}>V2 CONTRACTS</span></Button>
                                    </Tooltip>
                                </div>
                            </CustomSearch>
                        </div>
