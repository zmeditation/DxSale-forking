...
export const DxMint = () => {
    ...
    const [tokenTypeSelect, setSelect] = React.useState(TokenType.StandardToken);
    ...
    const createTokens = () => {
        ...
        setLoading(true);
        if (account) {
            if (tokenTypeSelect == TokenType.StandardToken) {
                const dxSaleSC = new web3.eth.Contract(
                    dxsaleAbi,
                    DxSaleSCAddress.Ropsten
                );
                ...
                dxSaleSC.methods
                    .createStandardToken(
                        ...
                        formState.tokenSupply.toString() + '000000000000000000',
                    )
                    .send({
                        from: account,
            ...
            } else if (tokenTypeSelect == TokenType.LiquidityToken) {
